...
{
    public class GiaCayTrongVatNuoiExcelController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaCayTrongVatNuoiExcelController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        ...
        [Route("GiaCayTrongVatNuoiExcel/Create")]
        [HttpGet]
