...
{
    public class GiaCayTrongVatNuoiDmController : Controller
    {
        private readonly CSDLGiaDBContext _db;
        private readonly IWebHostEnvironment _env;

        public GiaCayTrongVatNuoiDmController(CSDLGiaDBContext db, IWebHostEnvironment hostingEnv)
        {
            _db = db;
            _env = hostingEnv;
        }

        [Route("GiaCayTrongVatNuoiDmCt")]
        [HttpGet]
        ...
        [Route("GiaCayTrongVatNuoiDmCt/Store")]
        [HttpPost]
        public JsonResult Store(string Manhom, string Level, string Cap1, string Cap2, string Cap3, string Cap4, string Cap5, string Dvt, string Tennhom, string Theodoi)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuetn.danhmuc", "Create"))
                {
                    ...
                    _db.GiaCayTrongVatNuoiDm.Add(request);
                    _db.SaveChanges();
        ...
        [Route("GiaCayTrongVatNuoiDmCt/Edit")]
        [HttpPost]
        ...
        [Route("GiaCayTrongVatNuoiDmCt/Update")]
        [HttpPost]
        ...
        [Route("GiaCayTrongVatNuoiDmCt/Delete")]
        [HttpPost]
        ...
        [Route("GiaCayTrongVatNuoiDmCt/Lock")]
        [HttpPost]
        ...
        [Route("GiaCayTrongVatNuoiDmCt/Excel")]
        [HttpPost]
                ...
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuetn.danhmuc", "Edit"))
                {
                    ...
                    using (var stream = new MemoryStream())
                    {
                        ...
                        using (var package = new ExcelPackage(stream))
                        {
                            ...
                            {
                                list_add.Add(new GiaCayTrongVatNuoiDm
                                {
                                    Manhom = Manhom,
                                    Theodoi = "TD",
                                    Created_at = DateTime.Now,
                    ...
                    _db.GiaCayTrongVatNuoiDm.AddRange(list_add);
                    _db.SaveChanges();
