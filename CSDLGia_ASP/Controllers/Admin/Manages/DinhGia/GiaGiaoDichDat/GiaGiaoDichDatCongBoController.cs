...
{ 
    public class GiaGiaoDichDatCongBoController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaGiaoDichDatCongBoController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("GiaGiaoDichDat/CongBo")]
        [HttpGet]
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.giagiaodichdattrenthitruong.xetduyet", "Index"))
                {
                    ...
                    if (getdonvi.Level == "H")
                    {
                        ...
                        return View("Views/Admin/Systems/CongBo/GiaGiaoDichDatCongBo.cshtml", model_join);
                    }
