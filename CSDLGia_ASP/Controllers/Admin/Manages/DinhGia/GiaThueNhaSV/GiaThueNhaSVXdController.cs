...
{
    public class GiaThueNhaSVXdController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaThueNhaSVXdController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("GiaThueNhaSV/XetDuyet")]
        [HttpGet]
        public IActionResult Index(string Madv, string Nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.xetduyet", "Index"))
                {
                    ...
                    var model = _db.GiaThueNhaSV.ToList();
                    ...
                    if (getdonvi.Level == "H")
                    {
                        ...
                        var model_new = (from kk in model
                                          select new CSDLGia_ASP.Models.Manages.DinhGia.GiaThueNhaSV
                                          {
                                              Id = kk.Id,
                                              Mahs = kk.Mahs,
                        ...
                        ViewData["Madv"] = Madv;
                        ViewData["Nam"] = Nam;
                        ViewData["Title"] = "Thông tin hồ sơ giá nhà cho sinh viên thuê";
                        ViewData["MenuLv1"] = "menu_dg";
                        ViewData["MenuLv2"] = "menu_dg_nhaosinhvien";
                        ViewData["MenuLv3"] = "menu_dg_nhaosinhvien_xd";
                        return View("Views/Admin/Manages/DinhGia/GiaThueNhaSV/XetDuyet/Index.cshtml", model_join);
                    }
        ...
        public IActionResult ChuyenXd(string mahs, string madv, string macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.xetduyet", "Approve"))
                {
                    ...
                    return RedirectToAction("Index", "GiaThueNhaSVXd", new { Madv = madv, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult TraLai(int id_tralai, string madv_tralai)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.xetduyet", "Approve"))
                {
                    var model = _db.GiaThueNhaSV.FirstOrDefault(t => t.Id == id_tralai);
                    ...
                    return RedirectToAction("Index", "GiaThueNhaSVXd", new { Madv = madv_tralai, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult CongBo(string mahs_cb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.xetduyet", "Approve"))
                {
                    var model = _db.GiaThueNhaSV.FirstOrDefault(t => t.Mahs == mahs_cb);
                    ...
                    return RedirectToAction("Index", "GiaThueNhaSVXd");
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult HuyCongBo(string mahs_hcb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.xetduyet", "Approve"))
                {
                    var model = _db.GiaThueNhaSV.FirstOrDefault(t => t.Mahs == mahs_hcb);
        ...
        private static string GetMadvChuyen(string macqcq, CSDLGia_ASP.Models.Manages.DinhGia.GiaThueNhaSV hoso)
        {
            string madv = "";
