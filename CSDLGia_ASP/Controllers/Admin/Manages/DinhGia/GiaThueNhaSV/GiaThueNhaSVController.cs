...
{
    public class GiaThueNhaSVController : Controller
    {
        private readonly CSDLGiaDBContext _db;
        private readonly IWebHostEnvironment _hostEnvironment;

        public GiaThueNhaSVController(CSDLGiaDBContext db, IWebHostEnvironment hostEnvironment)
        {
            _db = db;
            _hostEnvironment = hostEnvironment;
        }

        [Route("GiaThueNhaSV/DanhSach")]
        [HttpGet]
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Index"))
                {
                    ...
                    if (dsdonvi.Count > 0)
                    {
                        ...
                        var model = _db.GiaThueNhaSV.Where(t => t.Madv == Madv).ToList();
        ...
        public IActionResult Create(string Manhom, string MadvBc)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Create"))
                {
                    ...
                    if (check != null)
                    {
                        _db.GiaThueNhaSVCt.RemoveRange(check);
                        _db.SaveChanges();
                    }

                    var model = new CSDLGia_ASP.Models.Manages.DinhGia.GiaThueNhaSV
                    {
                    ...
                    var danhmuc = _db.GiaThueNhaSVDm.ToList();
                    if (Manhom != "all")
                    {
                    ...
                    var chitiet = new List<GiaThueNhaSVCt>();
                    ...
                    _db.GiaThueNhaSVCt.AddRange(chitiet);
                    _db.SaveChanges();

                    model.GiaThueNhaSVCt = chitiet.Where(t => t.Mahs == model.Mahs).ToList();
        ...
        [Route("GiaThueNhaSV/Store")]
        [HttpPost]
        public async Task<IActionResult> Store(CSDLGia_ASP.Models.Manages.DinhGia.GiaThueNhaSV request, IFormFile Ipf1upload)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Create"))
                {
                    ...
                    _db.GiaThueNhaSV.Add(model);
                    _db.SaveChanges();

                    var modelct = _db.GiaThueNhaSVCt.Where(t => t.Mahs == request.Mahs);
                    if (modelct != null)
                    {
                    ...
                    _db.GiaThueNhaSVCt.UpdateRange(modelct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "GiaThueNhaSV", new { request.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Edit"))
                {
                    ...
                    var model_ct = _db.GiaThueNhaSVCt.Where(t => t.Mahs == model.Mahs);
        ...
        [Route("GiaThueNhaSV/Update")]
        [HttpPost]
        public async Task<IActionResult> Update(CSDLGia_ASP.Models.Manages.DinhGia.GiaThueNhaSV request, IFormFile Ipf1upload)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Edit"))
                {
                    ...
                    var model = _db.GiaThueNhaSV.FirstOrDefault(t => t.Mahs == request.Mahs);
        ...
        public IActionResult Delete(int id_delete)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Delete"))
                {
                    ...
                    var model_ct = _db.GiaThueNhaSVCt.Where(t => t.Mahs == model.Mahs);
                    _db.GiaThueNhaSVCt.RemoveRange(model_ct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "GiaThueNhaSV", new { model.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("GiaThueNhaSV/TimKiem/KetQua")]
        [HttpPost]
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.nhaosinhvien.thongtin", "Index"))
                {
                    var model = (from giathuetnct in _db.GiaThueNhaSVCt
                                 ...
                                 /*join nhomtn in _db.GiaThueNhaSVNhom on giathuetn.Manhom equals nhomtn.Manhom*/
        ...
        [Route("GiaThueNhaSVCt/Edit")]
        [HttpPost]
        public JsonResult EditCt(int Id)
        {
            var model = _db.GiaThueNhaSVCt.FirstOrDefault(p => p.Id == Id);
        ...
        [Route("GiaThueNhaSVCt/Update")]
        [HttpPost]
        public JsonResult UpdateCt(int Id, double Gia)
        {
            var model = _db.GiaThueNhaSVCt.FirstOrDefault(t => t.Id == Id);
            model.Gia = Gia;
            model.Updated_at = DateTime.Now;
            _db.GiaThueNhaSVCt.Update(model);
            _db.SaveChanges();
        ...
        {
            var model = _db.GiaThueNhaSVCt.Where(t => t.Mahs == Mahs).ToList();
