...
namespace CSDLGia_ASP.Controllers.Admin.Manages.DinhGia.GiaDichVuCongIchCongBo
{
    public class GiaDichVuCongIchCongBoController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaDichVuCongIchCongBoController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        [Route("GiaDvCi/CongBo")]
        [HttpGet]
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.dichvucongich.xetduyet", "Index"))
                {
                    ...
                    if (getdonvi.Level == "ADMIN")
                    {
                        ...
                        return View("Views/Admin/Systems/CongBo/GiaSpDichVuCongIchCongBo.cshtml", model_join);
