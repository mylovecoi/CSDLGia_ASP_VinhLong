    ...
    public class GiaKhungGiaDatCtController : Controller
    {
        ...
        public JsonResult Edit(int Id)
        {
            ...
            if (model != null)
            {
                ...
                result += "<input type='text' id='giattdb_edit' name='giattdb_edit' class='form-control money-decimal-mask' value='" +Helpers.ConvertDbToStr(model.Giattdb) + "'/>";
                result += "</div>";
                result += "</div>";
                result += "<div class='col-xl-6'>";
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá tối đa</b></label>";
                result += "<input type='text' id='giatddb_edit' name='giatddb_edit' class='form-control money-decimal-mask' value='" + Helpers.ConvertDbToStr(model.Giatddb) + "'/>";
                result += "</div>";
                result += "</div>";
                result += "</div>";
                ...
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá tối thiểu</b></label>";
                result += "<input type='text' id='giatttd_edit' name='giatttd_edit' class='form-control money-decimal-mask' value='" + Helpers.ConvertDbToStr(model.Giatttd) + "'/>";
                result += "</div>";
                result += "</div>";
                result += "<div class='col-xl-6'>";
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá tối đa</b></label>";
                result += "<input type='text' id='giatdtd_edit' name='giatdtd_edit' class='form-control money-decimal-mask' value='" + Helpers.ConvertDbToStr(model.Giatdtd) + "'/>";
                result += "</div>";
                result += "</div>";
                result += "</div>";
                ...
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá tối thiểu</b></label>";
                result += "<input type='text' id='giattmn_edit' name='giattmn_edit' class='form-control money-decimal-mask' value='" + Helpers.ConvertDbToStr(model.Giattmn) + "'/>";
                result += "</div>";
                result += "</div>";
                result += "<div class='col-xl-6'>";
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá tối đa</b></label>";
                result += "<input type='text' id='giatdmn_edit' name='giatdmn_edit' class='form-control money-decimal-mask' value='" + Helpers.ConvertDbToStr(model.Giatdmn) + "'/>";
                result += "</div>";
                result += "</div>";
                result += "</div>";
