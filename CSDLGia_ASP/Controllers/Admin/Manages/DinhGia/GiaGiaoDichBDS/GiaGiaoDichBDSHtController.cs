...
{
    public class GiaGiaoDichBDSHtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaGiaoDichBDSHtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("GiaGiaoDichBDS/XetDuyet")]
        [HttpGet]
        ...
        public IActionResult Index(string Madv, string Nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuedatnuoc.xetduyet", "Index"))
                {
                    ...
                    {
                        var model = _db.GiaGiaoDichBDS.Where(t => t.Madv_ad == Madv).ToList();
                        ...
                        ViewData["Title"] = "Hoàn thành định giá giao dịch bất động sản";
                        ViewData["MenuLv1"] = "menu_dg";
                        ViewData["MenuLv2"] = "menu_dggdbds";
                        ViewData["MenuLv3"] = "menu_dggdbds_ht";
                        return View("Views/Admin/Manages/DinhGia/GiaGiaoDichBDS/HoanThanh/Index.cshtml", model_join);
                    }
                    else if (getdonvi.Level == "T")
                    {
                        var model = _db.GiaGiaoDichBDS.Where(t => t.Madv_t == Madv).ToList();
                        if (string.IsNullOrEmpty(Nam))
                        {
                            model = model.ToList();
                        }
                    ...
                    {
                        var model = _db.GiaGiaoDichBDS.Where(t => t.Madv_h == Madv).ToList();
                        if (string.IsNullOrEmpty(Nam))
                        {
                            model = model.ToList();
                        }
        ...
        public IActionResult HoanThanh(string mahs_complete, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                {
                    var model = _db.GiaGiaoDichBDS.FirstOrDefault(p => p.Mahs == mahs_complete);
        ...
        public IActionResult ChuyenHoanThanh(string mahs_complete, string Macqcq, string madv_hientai)
        {
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuedatnuoc.xetduyet", "Approve"))
                {
                    ...
                    _db.GiaGiaoDichBDS.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "GiaGiaoDichBDSHt", new { Madv = madv_hientai, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult TraLai(int id_tralai, string madv_tralai)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuedatnuoc.xetduyet", "Approve"))
                {
                    var model = _db.GiaGiaoDichBDS.FirstOrDefault(t => t.Id == id_tralai);
                    ...
                    return RedirectToAction("Index", "GiaGiaoDichBDSHt", new { Madv = madv_tralai, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult CongBo(string mahs_cb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                {
                    var model = _db.GiaGiaoDichBDS.FirstOrDefault(t => t.Mahs == mahs_cb);
                    ...
                    _db.GiaGiaoDichBDS.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "GiaGiaoDichBDSHt");
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult HuyCongBo(string mahs_hcb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuedatnuoc.xetduyet", "Approve"))
                {
                    var model = _db.GiaGiaoDichBDS.FirstOrDefault(t => t.Mahs == mahs_hcb);
