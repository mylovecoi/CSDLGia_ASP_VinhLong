            ...
            foreach (var nhom in NhomDm)
            {
                ...
                if (data_nhom.Any())
                {
                    ...
                    foreach (var item in data_nhom.OrderBy(t => t.STTSapXep))
                    {
                        ...
                        result += "<td style='text-align:center'>" + item.GiaRung1 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaRung2 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaRung3 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaRung4 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaRung5 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaRung6 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaChoThue1 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaChoThue2 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaBoiThuong1 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaBoiThuong2 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaBoiThuong3 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaBoiThuong4 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaBoiThuong5 + "</td>";
                        result += "<td style='text-align:center'>" + item.GiaBoiThuong6 + "</td>";
