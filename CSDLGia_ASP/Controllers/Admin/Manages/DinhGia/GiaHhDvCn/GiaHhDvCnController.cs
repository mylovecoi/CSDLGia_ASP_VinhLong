...
namespace CSDLGia_ASP.Controllers.Admin.Manages.DinhGia.GiaHhDvCn
{
    public class GiaHhDvCnController : Controller
    {
        ...
        public IActionResult Create(string MadvBc)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hhdvcn.thongtin", "Create"))
                {
        ...
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hhdvcn.thongtin", "Edit"))
                {
        ...
        //                ViewData["MenuLv1"] = "menu_dg";
        //                ViewData["MenuLv2"] = "menu_spdvcuthe";
        //                ViewData["MenuLv3"] = "menu_spdvcuthe_tk";
        ...
        //                             select new GiaHhDvCnCt
        //                             {
        //                                 Id = GiaHhDvCnct.Id,
        //                                 Dvt = GiaHhDvCnct.Dvt,
        //                                 Mahs = GiaHhDvCnct.Mahs,
        //                                 Madv = GiaHhDvCn.Madv,
        //                                 Thoidiem = GiaHhDvCn.Thoidiem,
        //                                 Tendv = donvi.TenDv,
        //                                 Soqd = GiaHhDvCn.Soqd,
        //                                 Mucgia = GiaHhDvCnct.Mucgia,
