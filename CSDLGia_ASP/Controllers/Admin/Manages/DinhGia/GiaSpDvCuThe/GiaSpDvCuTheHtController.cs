...
namespace CSDLGia_ASP.Controllers.Admin.Manages.DinhGia.GiaSpDvCuThe
{
    public class GiaSpdvCuTheHtController : Controller
    {
        ...
        public GiaSpdvCuTheHtController(CSDLGiaDBContext db)
        {
            _db = db;
        }
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuetn.xetduyet", "Index"))
                {
                    ...
                    if (getdonvi.Level == "H")
                    {
                        ...
                        ViewData["MenuLv3"] = "menu_spdvcuthe_ht";
        ...
        public IActionResult CongBo(string mahs_cb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.spdvcuthe.xetduyet", "Approve"))
                {
