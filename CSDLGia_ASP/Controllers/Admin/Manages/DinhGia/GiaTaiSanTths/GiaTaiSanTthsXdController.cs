...
{
    public class GiaTaiSanTthsXdController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaTaiSanTthsXdController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("GiaTaiSanTths/XetDuyet")]
        [HttpGet]
        public IActionResult Index(string Madv, string Nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.tths.xetduyet", "Index"))
                {
                    ...
                    var model = _db.GiaTaiSanTths.ToList();
                    ...
                    if (getdonvi.Level == "H")
                    {
                        ...
                        var model_new = (from kk in model
                                         select new CSDLGia_ASP.Models.Manages.DinhGia.GiaTaiSanTths
                                         {
                                             Id = kk.Id,
                                             Mahs = kk.Mahs,
        ...
        public IActionResult ChuyenXd(string mahs, string madv, string macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.tths.xetduyet", "Approve"))
                {
                    ...
                    return RedirectToAction("Index", "GiaTaiSanTthsXd", new { Madv = madv, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult TraLai(int id_tralai, string madv_tralai, string Lydo)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.tths.xetduyet", "Approve"))
                {
                    var model = _db.GiaTaiSanTths.FirstOrDefault(t => t.Id == id_tralai);
                    ...
                    return RedirectToAction("Index", "GiaTaiSanTthsXd", new { Madv = madv_tralai, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult CongBo(string mahs_cb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.tths.xetduyet", "Approve"))
                {
                    var model = _db.GiaTaiSanTths.FirstOrDefault(t => t.Mahs == mahs_cb);
                    ...
                    return RedirectToAction("Index", "GiaTaiSanTthsXd");
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult HuyCongBo(string mahs_hcb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.tths.xetduyet", "Approve"))
                {
                    var model = _db.GiaTaiSanTths.FirstOrDefault(t => t.Mahs == mahs_hcb);
        ...
        private static string GetMadvChuyen(string macqcq, CSDLGia_ASP.Models.Manages.DinhGia.GiaTaiSanTths hoso)
        {
            string madv = "";
