...
{
    public class GiaThueTaiNguyenCongBoController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaThueTaiNguyenCongBoController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("GiaThueTaiNguyen/CongBo")]
        [HttpGet]
            ...
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.thuetn.xetduyet", "Index"))
                {
                    ...
                    if (getdonvi.Level == "H")
                    {
                        ...
                        return View("Views/Admin/Systems/CongBo/GiaThueTaiNguyenCongBo.cshtml", model_join);
                    }
