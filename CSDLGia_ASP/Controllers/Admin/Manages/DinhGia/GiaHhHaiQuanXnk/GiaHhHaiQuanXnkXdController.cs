...
{
    public class GiaHhHaiQuanXnkXdController : Controller
    {
        private readonly CSDLGiaDBContext _db;
        private readonly IWebHostEnvironment _hostEnvironment;

        public GiaHhHaiQuanXnkXdController(CSDLGiaDBContext db, IWebHostEnvironment hostEnvironment)
        {
            _db = db;
            _hostEnvironment = hostEnvironment;
        }
        [Route("GiaHhHaiQuanXnkXd/XetDuyet")]
        [HttpGet]
        public IActionResult Index(string Madv, string Nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hqxnk.xetduyet", "Index"))
                {
                    ...
                    var model = _db.GiaHhHaiQuanXnk.ToList();
        ...
        public IActionResult Complete(string mahs_complete, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hqxnk.thongtin", "Approve"))
                {
                    var model = _db.GiaHhHaiQuanXnk.FirstOrDefault(p => p.Mahs == mahs_complete);
                    ...
                    model.Macqcq = Macqcq;
                    model.Madiaban = chk_dvcq.MaDiaBan;
                    ...
                    _db.SaveChanges();
                    return RedirectToAction("Index", "GiaHhHaiQuanXnk", new { model.Mahs, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult TraLai(int id_tralai, string madv_tralai)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hqxnk.xetduyet", "Approve"))
                {
                    var model = _db.GiaHhHaiQuanXnk.FirstOrDefault(t => t.Id == id_tralai);
                    ...
                    return RedirectToAction("Index", "GiaHhHaiQuanXnkXd", new { Madv = madv_tralai, Nam = model.Thoidiem.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult CongBo(string mahs_cb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hqxnk.xetduyet", "Approve"))
                {
                    var model = _db.GiaHhHaiQuanXnk.FirstOrDefault(t => t.Mahs == mahs_cb);
                    ...
                    return RedirectToAction("Index", "GiaHhHaiQuanXnkXd");
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult HuyCongBo(string mahs_hcb)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.hqxnk.xetduyet", "Approve"))
                {
                    var model = _db.GiaHhHaiQuanXnk.FirstOrDefault(t => t.Mahs == mahs_hcb);
        ...
        private static string GetMadvChuyen(string macqcq, CSDLGia_ASP.Models.Manages.DinhGia.GiaHhHaiQuanXnk hoso)
        {
            string madv = "";
