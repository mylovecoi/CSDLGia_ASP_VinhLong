...
{
    public class GiaHhHaiQuanXnkExcelController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public GiaHhHaiQuanXnkExcelController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        ...
        public IActionResult Index(string Madv)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.dinhgia.xaydungmoi.thongtin", "Create"))
                {
                    ...
                    return View("Views/Admin/Manages/DinhGia/GiaHhHaiQuanXnk/Excels/Excel.cshtml", model);
        ...
        [Route("GiaHhHaiQuanXnkExcel/Create")]
        [HttpGet]
