    ...
    public class TaiSanCongCtController : Controller
    {
        ...
        public JsonResult Edit(int Id)
        {
            ...
            if (model != null)
            {
                ...
                result += "<input type='text' id='Giathue_edit' name='Giathue_edit' value='" + @model.Giathue + "'class='form-control money text-right' style='font-weight: bold'/>";
                result += "</div>";
                result += "</div>";
                result += "<div class='col-xl-6'>";
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá còn lại</b></label>";
                result += "<input type='text' id='Giaconlai_edit' name='Giaconlai_edit' value='" + @model.Giaconlai + "' class='form-control money text-right' style='font-weight: bold'/>";
                result += "</div>";
                result += "</div>";
                result += "<div class='col-xl-6'>";
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá phê duyệt</b></label>";
                result += "<input type='text' id='Giapheduyet_edit' name='Giapheduyet_edit' value='" + @model.Giapheduyet + "' class='form-control money text-right' style='font-weight: bold'/>";
                result += "</div>";
                result += "</div>";
                result += "<div class='col-xl-6'>";
                result += "<div class='form-group fv-plugins-icon-container'>";
                result += "<label><b>Giá bán (thanh lý)</b></label>";
                result += "<input type='text' id='Giaban_edit' name='Giaban_edit' value='" + @model.Giaban + "' class='form-control money text-right' style='font-weight: bold'/>";
                result += "</div>";
                result += "</div>";
                result += "</div>";
                result += "</div>";
