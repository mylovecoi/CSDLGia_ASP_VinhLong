...
{
    public class KkGiaTpcnBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaTpcnBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        [Route("BaoCaoKkGiaTpcn")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgtpcn.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá thực phẩm chức năng";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgtpcn";
                    ViewData["MenuLv3"] = "menu_giakkbctpcn";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaTpcn/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgtpcn.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgtpcn";
                    ViewData["MenuLv3"] = "menu_giakkbctpcn";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaTpcn/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgtpcn.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGsCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá thực phẩm chức năng";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgtpcn";
                    ViewData["MenuLv3"] = "menu_giakkbctpcn";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaTpcn/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
