...
{
    public class KkGsCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGsCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        ...
        [Route("KkGiaTpcnCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGsCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGsCt.Where(t => t.Mahs == Mahs).ToList();
