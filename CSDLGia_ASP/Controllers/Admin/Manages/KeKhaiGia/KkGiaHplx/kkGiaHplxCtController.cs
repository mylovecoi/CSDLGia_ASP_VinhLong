...
{
    public class kkGiaHplxCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;
        public kkGiaHplxCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaHplxCt/Store")]
        [HttpPost]
        ...
        [Route("KkGiaHplxCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaHpLxCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaHpLxCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaHplxCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaHpLxCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaHpLxCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
