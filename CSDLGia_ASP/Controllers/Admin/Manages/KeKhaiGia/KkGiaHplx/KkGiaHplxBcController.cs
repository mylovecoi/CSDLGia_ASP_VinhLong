...
{
    public class KkGiaHplxBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaHplxBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        [Route("BaoCaoKkGiaHplx")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkghplx.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá học phí lái xe";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkghplx";
                    ViewData["MenuLv3"] = "menu_giakkbchplx";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaHplx/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkghplx.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkghplx";
                    ViewData["MenuLv3"] = "menu_giakkbchplx";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaHplx/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkghplx.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaHpLxCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá học phí lái xe";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkghplx";
                    ViewData["MenuLv3"] = "menu_giakkbchplx";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaHplx/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
