...
{
    public class KkGiaCatSanCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaCatSanCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        ...
        [Route("KkGiaCatSanCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaCatSanCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaCatSanCt.FirstOrDefault(t => t.Id == Id);
            ...
            _db.KkGiaCatSanCt.Update(model);
            _db.SaveChanges();
        ...
        [Route("KkGiaCatSanCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaCatSanCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaCatSanCt.Remove(model);
            _db.SaveChanges();
