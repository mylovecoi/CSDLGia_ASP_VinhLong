...
{
    public class KkGiaCatSanController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaCatSanController(CSDLGiaDBContext db) => _db = db;
        ...
        public IActionResult Index(string Madv, string Nam, string Trangthai)
        {
            ...
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakk", "Index") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    var Manghe = "CATSAN";
                    var dsdonvi = (from com in _db.Company
                                   join lvkd in _db.CompanyLvCc.Where(t => t.Manghe == "CATSAN") on com.Mahs equals lvkd.Mahs
                    ...
                    if (dsdonvi.Count > 0)
                    {
                        ...
                        if (comct.Count > 0)
                        {
                            ...
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá cát sạn";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgcatsan";
                            ViewData["MenuLv3"] = "menu_giakkcatsan";
                            return View("Views/Admin/Manages/KeKhaiGia/KkGiacatSan/Index.cshtml", model);
                        }
                        else
                        {
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá cát sạn";
                            ViewData["Messages"] = "Kê khai giá cát sạn không thuộc quản lý của doanh nghiệp";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgcatsan";
                            ViewData["MenuLv3"] = "menu_giakkcatsan";
                    ...
                    {
                        ViewData["Title"] = "Danh sách hồ sơ kê khai giá cat san";
                        ViewData["Messages"] = "Hệ thống chưa có doanh nghiệp kê khai giá cat san.";
                        ViewData["MenuLv1"] = "menu_kknygia";
                        ViewData["MenuLv2"] = "menu_kkgcatsan";
                        ViewData["MenuLv3"] = "menu_giakkcatsan"; ;
                        return View("Views/Admin/Error/ThongBaoLoi.cshtml");
        ...
        public IActionResult Create(string Madv, string Manghe)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkcatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/Create.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Store(VMKkGia request)
        {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
            {
                   ...
                   Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var modelct = _db.KkGiaCatSanCt.Where(t => t.Madv == request.Madv);
                    if (modelct != null)
                    {
                    ...
                    _db.KkGiaCatSanCt.UpdateRange(modelct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkGiaCatSan", new { request.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaCatSan/Edit")]
        [HttpGet]
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakk", "Edit") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaCatSanCt.Where(t => t.Mahs == model_new.Mahs && t.Madv == model_new.Madv);

                    model_new.KkGiaCatSanCt = model_ct.ToList();

                    ViewData["Madv"] = model.Madv;
                    ViewData["Title"] = "Chỉnh sửa Kê khai giá cat san";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkcatsan";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/Edit.cshtml", model_new);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaCatSan/Delete")]
        [HttpPost]
        public IActionResult Delete(int id_delete)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakk", "Delete")
                    || Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaCatSanCt.Where(t => t.Mahs == model.Mahs && t.Madv == model.Madv);
                    _db.KkGiaCatSanCt.RemoveRange(model_ct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkGiaCatSan", new { model.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Show(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    || Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var modelct = _db.KkGiaCatSanCt.Where(t => t.Mahs == model.Mahs);
                    if (modelct != null)
                    {
                        hoso_kk.KkGiaCatSanCt = modelct.ToList();
                    }

                    ViewData["Title"] = "Kê khai giá cat san";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkcatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/Show.cshtml", hoso_kk);
        ...
        public IActionResult Chuyen(string mahs_chuyen, string Ttnguoinop, string Dtll, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakk", "Approve")
                    || Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    _db.KkGia.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "KkGiaCatSan", new { model.Madv, Nam = model.Ngaynhap.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Search(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgsach.giakk", "Index"))
                {
                    ...
                    var model_join = from kkct in _db.KkGiaCatSanCt
                                     join kk in _db.KkGia.Where(t => t.Manghe == "CATSAN" && t.Trangthai == "DD") on kkct.Mahs equals kk.Mahs
                    ...
                    ViewData["Nam"] = Nam;
                    ViewData["Mota"] = Mota;
                    ViewData["Title"] = "Tìm kiếm thông tin kê khai giá cat san";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkcatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/TimKiem/Index.cshtml", model_join);
        ...
        public IActionResult Printf(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakk", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkcatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/TimKiem/Printf.cshtml", model_join);
