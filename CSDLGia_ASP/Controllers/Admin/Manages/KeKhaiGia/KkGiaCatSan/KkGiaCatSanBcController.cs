...
{
    public class KkGiaCatSanBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaCatSanBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        [Route("BaoCaoKkGiaCatSan")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá cát sạn";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkbccatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkbccatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcatsan.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaCatSanCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá cát sạn";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcatsan";
                    ViewData["MenuLv3"] = "menu_giakkbccatsan";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaCatSan/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
