...
{
    public class KkGiaDvChController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaDvChController(CSDLGiaDBContext db)
        {
            _db = db;
        }
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    if (dsdonvi.Count > 0)
                    {
                        ...
                        if (comct.Count > 0)
                        {
                            ...
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá dịch vụ ca Huế sông Hương";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgcahue";
                            ViewData["MenuLv3"] = "menu_giakkcahue";
                            return View("Views/Admin/Manages/KeKhaiGia/KkGiaDvCh/Index.cshtml", model);
                        }
                        else
                        {
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá dịch vụ ca Huế sông Hương";
                            ViewData["Messages"] = "Kê khai giá dịch vụ ca Huế sông Hương không thuộc quản lý của doanh nghiệp";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgcahue";
                            ViewData["MenuLv3"] = "menu_giakkcahue";
                    ...
                    {
                        ViewData["Title"] = "Danh sách hồ sơ kê khai giá dịch vụ ca Huế sông Hương";
                        ViewData["Messages"] = "Hệ thống chưa có doanh nghiệp kê khai giá dịch vụ ca Huế sông Hương.";
                        ViewData["MenuLv1"] = "menu_kknygia";
                        ViewData["MenuLv2"] = "menu_kkgcahue";
                        ViewData["MenuLv3"] = "menu_giakkcahue";
                        return View("Views/Admin/Error/ThongBaoLoi.cshtml");
        ...
        [Route("KeKhaiGiaDvCh/Create")]
        [HttpGet]
        public IActionResult Create(string Madv, string Manghe)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcahue.giakk", "Create") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Tendn"] = _db.Company.FirstOrDefault(t => t.Madv == Madv).Tendn;
                    ViewData["Manghe"] = Manghe;
                    ViewData["Title"] = "Thêm mới Kê khai giá dịch vụ ca Huế sông Hương";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcahue";
                    ViewData["MenuLv3"] = "menu_giakkcahue";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDvCh/Create.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Store(VMKkGia request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var modelct = _db.KkGiaDvChCt.Where(t => t.Mahs == request.Mahs);
                    if (modelct != null)
                    {
                    ...
                    _db.KkGiaDvChCt.UpdateRange(modelct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkGiaDvCh", new { request.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaDvCh/Edit")]
        [HttpGet]
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcahue.giakk", "Edit") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaDvChCt.Where(t => t.Mahs == model_new.Mahs && t.Madv == model_new.Madv);

                    model_new.KkGiaDvChCt = model_ct.ToList();

                    ViewData["Madv"] = model.Madv;
                    ViewData["Title"] = "Chỉnh sửa Kê khai giá dịch vụ ca Huế sông Hương";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcahue";
                    ViewData["MenuLv3"] = "menu_giakkcahue";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDvCh/Edit.cshtml", model_new);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaDvCh/Delete")]
        [HttpPost]
        public IActionResult Delete(int id_delete)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcahue.giakk", "Delete") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaDvChCt.Where(t => t.Mahs == model.Mahs && t.Madv == model.Madv);
                    _db.KkGiaDvChCt.RemoveRange(model_ct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkGiaDvCh", new { model.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Show(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Title"] = "Kê khai giá dịch vụ ca Huế sông Hương";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcahue";
                    ViewData["MenuLv3"] = "menu_giakkcahue";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDvCh/Show.cshtml", model);
        ...
        public IActionResult Search(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcahue.giakk", "Index"))
                {
                    ...
                    var model_join = from kkct in _db.KkGiaDvChCt
                                     join kk in _db.KkGia.Where(t => t.Manghe == "CAHUE" && t.Trangthai == "DD") on kkct.Mahs equals kk.Mahs
                    ...
                    ViewData["Nam"] = Nam;
                    ViewData["Mota"] = Mota;
                    ViewData["Title"] = "Tìm kiếm thông tin kê khai giá dịch vụ ca Huế sông Hương";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgcahue";
                    ViewData["MenuLv3"] = "menu_giakkcahuetk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDvCh/TimKiem/Index.cshtml", model_join);
        ...
        public IActionResult Printf(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcahue.giakk", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgcahue";
                    ViewData["MenuLv3"] = "menu_giakkcahuetk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDvCh/TimKiem/Printf.cshtml", model_join);
        ...
        public IActionResult Chuyen(string mahs_chuyen, string Ttnguoinop, string Dtll, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgcahue.giakkxd", "Approve") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    _db.KkGia.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "KkGiaDvCh", new { model.Madv, Nam = model.Ngaynhap.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        {
            var modelct = _db.KkGiaDvChCt.Where(t => t.Mahs == Mahs);
            if (modelct != null)
            {
                hoso.KkGiaDvChCt = modelct.ToList();
            }
            return hoso;
        }
