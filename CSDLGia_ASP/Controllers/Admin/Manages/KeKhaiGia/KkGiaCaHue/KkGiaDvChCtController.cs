...
{
    public class KkGiaDvChCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaDvChCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaDvChCt/Store")]
        [HttpPost]
        ...
        [Route("KkGiaDvChCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaDvChCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaDvChCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaDvChCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaDvChCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaDvChCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaDvChCt.Where(t => t.Mahs == Mahs).ToList();
