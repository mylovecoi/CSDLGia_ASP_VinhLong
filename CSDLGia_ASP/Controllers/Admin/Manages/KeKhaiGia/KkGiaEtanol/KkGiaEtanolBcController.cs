...
{
    public class KkGiaEtanolBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaEtanolBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        [Route("BaoCaoKkGiaEtanol")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgetanol.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá Etanol";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgetanol";
                    ViewData["MenuLv3"] = "menu_giakkbcetanol";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaEtanol/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgetanol.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgetanol";
                    ViewData["MenuLv3"] = "menu_giakkbcetanol";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaEtanol/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgetanol.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaEtanolCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá Etanol";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgetanol";
                    ViewData["MenuLv3"] = "menu_giakkbcetanol";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaEtanol/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
