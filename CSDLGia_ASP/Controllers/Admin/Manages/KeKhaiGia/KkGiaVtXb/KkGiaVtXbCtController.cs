...
{
    public class KkGiaVtXbCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaVtXbCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaVtXbCt/Store")]
        [HttpPost]
        ...
        [Route("KkGiaVtXbCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaVtXbCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaVtXbCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaVtXbCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaVtXbCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaVtXbCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaVtXbCt.Where(t => t.Mahs == Mahs).ToList();
