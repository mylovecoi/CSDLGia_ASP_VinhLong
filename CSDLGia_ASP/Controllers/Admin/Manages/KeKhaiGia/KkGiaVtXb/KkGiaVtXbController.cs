...
{
    public class KkGiaVtXbController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaVtXbController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        ...
        public IActionResult Index(string Madv, string Nam, string Trangthai)
        {
            ...
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakk", "Index") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    if (dsdonvi.Count > 0)
                    {
                        ...
                        if (comct.Count > 0)
                        {
                            ...
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgvtxb";
                            ViewData["MenuLv3"] = "menu_giakkvtxb";
                            return View("Views/Admin/Manages/KeKhaiGia/KkGiaVtXb/Index.cshtml", model);
                        }
                        else
                        {
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                            ViewData["Messages"] = "Kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định không thuộc quản lý của doanh nghiệp";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgvtxb";
                            ViewData["MenuLv3"] = "menu_giakkvtxb";
                    ...
                    {
                        ViewData["Title"] = "Danh sách hồ sơ kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                        ViewData["Messages"] = "Hệ thống chưa có doanh nghiệp kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định.";
                        ViewData["MenuLv1"] = "menu_kknygia";
                        ViewData["MenuLv2"] = "menu_kkgvtxb";
                        ViewData["MenuLv3"] = "menu_giakkvtxb";
                        return View("Views/Admin/Error/ThongBaoLoi.cshtml");
        ...
        [Route("KeKhaiGiaVtXb/Create")]
        [HttpGet]
        public IActionResult Create(string Madv, string Manghe)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakk", "Create") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Tendn"] = _db.Company.FirstOrDefault(t => t.Madv == Madv).Tendn;
                    ViewData["Manghe"] = Manghe;
                    ViewData["Title"] = "Thêm mới Kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvtxb";
                    ViewData["MenuLv3"] = "menu_giakkvtxb";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVtXb/Create.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Store(VMKkGia request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var modelct = _db.KkGiaVtXbCt.Where(t => t.Mahs == request.Mahs);
                    if (modelct != null)
                    {
                    ...
                    _db.KkGiaVtXbCt.UpdateRange(modelct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkGiaVtXb", new { request.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaVtXb/Edit")]
        [HttpGet]
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakk", "Edit") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaVtXbCt.Where(t => t.Mahs == model_new.Mahs && t.Madv == model_new.Madv);

                    model_new.KkGiaVtXbCt = model_ct.ToList();

                    ViewData["Madv"] = model.Madv;
                    ViewData["Title"] = "Chỉnh sửa Kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvtxb";
                    ViewData["MenuLv3"] = "menu_giakkvtxb";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVtXb/Edit.cshtml", model_new);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaVtXb/Delete")]
        [HttpPost]
        public IActionResult Delete(int id_delete)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakk", "Delete") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaVtXbCt.Where(t => t.Mahs == model.Mahs && t.Madv == model.Madv);
                    _db.KkGiaVtXbCt.RemoveRange(model_ct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkGiaVtXb", new { model.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Show(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Title"] = "Kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvtxb";
                    ViewData["MenuLv3"] = "menu_giakkvtxb";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVtXb/Show.cshtml", model);
        ...
        public IActionResult Search(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakk", "Index"))
                {
                    ...
                    var model_join = from kkct in _db.KkGiaVtXbCt
                                     join kk in _db.KkGia.Where(t => t.Manghe == "VTXB" && t.Trangthai == "DD") on kkct.Mahs equals kk.Mahs
                    ...
                    ViewData["Nam"] = Nam;
                    ViewData["Mota"] = Mota;
                    ViewData["Title"] = "Tìm kiếm thông tin kê khai giá cước vận tải hành khách bằng xe buýt theo tuyến cố định";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvtxb";
                    ViewData["MenuLv3"] = "menu_giakkvtxbtk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVtXb/TimKiem/Index.cshtml", model_join);
        ...
        public IActionResult Printf(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakk", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgvtxb";
                    ViewData["MenuLv3"] = "menu_giakkvtxbtk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVtXb/TimKiem/Printf.cshtml", model_join);
        ...
        public IActionResult Chuyen(string mahs_chuyen, string Ttnguoinop, string Dtll, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgvtxb.giakkxd", "Approve") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    _db.KkGia.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "KkGiaVtXb", new { model.Madv, Nam = model.Ngaynhap.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        {
            var modelct = _db.KkGiaVtXbCt.Where(t => t.Mahs == Mahs);
            if (modelct != null)
            {
                hoso.KkGiaVtXbCt = modelct.ToList();
            }
            return hoso;
        }
