...
{
    public class KkGiaDatSanLapCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaDatSanLapCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaDatSanLapCt/Store")]
        [HttpPost]
        ...
        {
            var model = new KkGiaDatSanLapCt
            {
                Mahs = Mahs,
                Madv = Madv,
                Tendvcu = Tendvcu,
            ...
            _db.KkGiaDatSanLapCt.Add(model);
            _db.SaveChanges();
        ...
        [Route("KkGiaDatSanLapCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaDatSanLapCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaDatSanLapCt.FirstOrDefault(t => t.Id == Id);
            ...
            _db.KkGiaDatSanLapCt.Update(model);
            _db.SaveChanges();
        ...
        [Route("KkGiaDatSanLapCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaDatSanLapCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaDatSanLapCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaDatSanLapCt.Where(t => t.Mahs == Mahs).ToList();
