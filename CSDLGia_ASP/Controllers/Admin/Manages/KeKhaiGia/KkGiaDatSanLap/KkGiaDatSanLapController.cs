...
{
    public class KkGiaDatSanLapController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaDatSanLapController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KeKhaiGiaDatSanLap")]
        [HttpGet]
        public IActionResult Index(string Madv, string Nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Index") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    var Manghe = "DATSANLAP";
                    ...
                    if (dsdonvi.Count > 0)
                    {
                        ...
                        if (comct.Count > 0)
                        {
                            ...
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá đất san lấp";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                            ViewData["MenuLv3"] = "menu_giakkdatsanlap";
                            return View("Views/Admin/Manages/KeKhaiGia/KkGiaDatSanLap/Index.cshtml", model);
                        }
                        else
                        {
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá đất san lấp";
                            ViewData["Messages"] = "Kê khai giá đất san lấp không thuộc quản lý của doanh nghiệp";
                            ViewData["MenuLv1"] = "menu_kknygia";
                    ...
                    {
                        ViewData["Title"] = "Danh sách hồ sơ kê khai giá đất san lấp";
                        ViewData["Messages"] = "Hệ thống chưa có doanh nghiệp kê khai giá đất san lấp.";
                        ViewData["MenuLv1"] = "menu_kknygia";
                        ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                        ViewData["MenuLv3"] = "menu_giakkdatsanlap";
                        return View("Views/Admin/Error/ThongBaoLoi.cshtml");
        ...
        [Route("KeKhaiGiaDatSanLap/Create")]
        [HttpGet]
        public IActionResult Create(string Madv, string Manghe)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Create") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Tendn"] = _db.Company.FirstOrDefault(t => t.Madv == Madv).Tendn;
                    ViewData["Manghe"] = Manghe;
                    ViewData["Title"] = "Thêm mới Kê khai giá đất san lấp";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                    ViewData["MenuLv3"] = "menu_giakkdatsanlap";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDatSanLap/Create.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaDatSanLap/Store")]
        [HttpPost]
        public IActionResult Store(VMKkGia request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var modelct = _db.KkGiaDatSanLapCt.Where(t => t.Mahs == request.Mahs);
                    if (modelct != null)
                    {
                    ...
                    _db.KkGiaDatSanLapCt.UpdateRange(modelct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KeKhaiGiaDatSanLap", new { request.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaDatSanLap/Edit")]
        [HttpGet]
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Edit") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaDatSanLapCt.Where(t => t.Mahs == model_new.Mahs && t.Madv == model_new.Madv);

                    model_new.KkGiaDatSanLapCt = model_ct.ToList();

                    ViewData["Madv"] = model.Madv;
                    ViewData["Title"] = "Chỉnh sửa Kê khai giá đất san lấp";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                    ViewData["MenuLv3"] = "menu_giakkdatsanlap";

                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDatSanLap/Edit.cshtml", model_new);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaDatSanLap/Update")]
        [HttpPost]
        ...
        [Route("KeKhaiGiaDatSanLap/Delete")]
        [HttpPost]
        public IActionResult Delete(int id_delete)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Delete") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkGiaDatSanLapCt.Where(t => t.Mahs == model.Mahs && t.Madv == model.Madv);
                    _db.KkGiaDatSanLapCt.RemoveRange(model_ct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KeKhaiGiaDatSanLap", new { model.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Show(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Title"] = "Kê khai giá đất san lấp";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                    ViewData["MenuLv3"] = "menu_giakkdatsanlap";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDatSanLap/Show.cshtml", model);
        ...
        [Route("KeKhaiGiaDatSanLap/Search")]
        [HttpGet]
        public IActionResult Search(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Index"))
                {
                    ...
                    var model_join = from kkct in _db.KkGiaDatSanLapCt
                                     join kk in _db.KkGia.Where(t => t.Manghe == "DATSANLAP" && t.Trangthai == "DD") on kkct.Mahs equals kk.Mahs
                    ...
                    ViewData["Nam"] = Nam;
                    ViewData["Mota"] = Mota;
                    ViewData["Title"] = "Tìm kiếm thông tin kê khai giá đất san lấp";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                    ViewData["MenuLv3"] = "menu_giakkdatsanlaptk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDatSanLap/TimKiem/Index.cshtml", model_join);
        ...
        [Route("KeKhaiGiaDatSanLap/Printf")]
        [HttpGet]
        public IActionResult Printf(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgdatsanlap";
                    ViewData["MenuLv3"] = "menu_giakkdatsanlaptk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDatSanLap/TimKiem/Printf.cshtml", model_join);
        ...
        public IActionResult Chuyen(string mahs_chuyen, string Ttnguoinop, string Dtll, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdatsanlap.giakk", "Approve") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    _db.KkGia.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "KkGiaDatSanLap", new { model.Madv, Nam = model.Ngaynhap.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        {
            var modelct = _db.KkGiaDatSanLapCt.Where(t => t.Mahs == Mahs);
            if (modelct != null)
            {
                hoso.KkGiaDatSanLapCt = modelct.ToList();
            }
            return hoso;
        }
