...
{
    public class KkGiaSieuThiCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaSieuThiCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaSieuThiCt/Store")]
        [HttpPost]
        ...
        [Route("KkGiaSieuThiCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaSieuThiCt.FirstOrDefault(p => p.Id == Id);
        ...
        public JsonResult Update(int Id, string Tendvcu, string Qccl, string Dvt, double Gialk, double Giakk, string Ghichu)
        {
            ...
            _db.KkGiaSieuThiCt.Update(model);
            _db.SaveChanges();
        ...
        [Route("KkGiaSieuThiCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaSieuThiCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaSieuThiCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaSieuThiCt.Where(t => t.Mahs == Mahs).ToList();
