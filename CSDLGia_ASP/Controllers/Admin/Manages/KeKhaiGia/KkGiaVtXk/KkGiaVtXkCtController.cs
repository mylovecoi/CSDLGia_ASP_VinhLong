...
namespace CSDLGia_ASP.Controllers.Admin.Manages.KeKhaiGia.KkGiaVtXk
{
    public class KkGiaVtXkCtController : Controller
    {
        ...
        [Route("KkGiaVtXkCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaVtXkCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaVtXkCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaVtXkCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaVtXkCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaVtXkCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaVtXkCt.Where(t => t.Mahs == Mahs).ToList();
