...
{
    public class KkGiaTaCnBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaTaCnBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("BaoCaoKkGiaTaCn")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgtacn.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá thức ăn chăn nuôi";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgtacn";
                    ViewData["MenuLv3"] = "menu_giakktacnbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaTaCn/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgtacn.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgtacn";
                    ViewData["MenuLv3"] = "menu_giakktacnbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaTaCn/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgtacn.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaTaCnCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá thức ăn chăn nuôi";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgtacn";
                    ViewData["MenuLv3"] = "menu_giakktacnbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaTaCn/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
