...
namespace CSDLGia_ASP.Controllers.Admin.Manages.KeKhaiGia.KkGiaTaCn
{
    public class KkGiaTaCnCtController : Controller
    {
        ...
        [Route("KkGiaTaCnCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaTaCnCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaTaCnCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaTaCnCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaTaCnCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaTaCnCt.Remove(model);
            _db.SaveChanges();
        ...
        {
            var model = _db.KkGiaTaCnCt.Where(t => t.Madv == Madv).ToList();
