...
{
    public class KkGiaDaXayDungBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaDaXayDungBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("BaoCaoKkGiaDaXayDung")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdaxaydung.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá đá xây dựng";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgdaxaydung";
                    ViewData["MenuLv3"] = "menu_giakkdaxaydungbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDaXayDung/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        [Route("BaoCaoKkGiaDaXayDung/Bc1")]
        [HttpPost]
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdaxaydung.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgdaxaydung";
                    ViewData["MenuLv3"] = "menu_giakkdaxaydungbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDaXayDung/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("BaoCaoKkGiaDaXayDung/Bc2")]
        [HttpPost]
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgdaxaydung.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaDaXayDungCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá đá xây dựng";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgdaxaydung";
                    ViewData["MenuLv3"] = "menu_giakkdaxaydungbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaDaXayDung/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
