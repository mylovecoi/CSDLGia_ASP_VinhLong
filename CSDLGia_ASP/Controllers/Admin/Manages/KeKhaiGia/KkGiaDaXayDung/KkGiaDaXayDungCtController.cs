...
{
    public class KkGiaDaXayDungCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaDaXayDungCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaDaXayDungCt/Store")]
        [HttpPost]
        ...
        {
            var model = new KkGiaDaXayDungCt
            {
                Mahs = Mahs,
                Madv = Madv,
                Tendvcu = Tendvcu,
            ...
            _db.KkGiaDaXayDungCt.Add(model);
            _db.SaveChanges();
        ...
        [Route("KkGiaDaXayDungCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaDaXayDungCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaDaXayDungCt.FirstOrDefault(t => t.Id == Id);
            ...
            _db.KkGiaDaXayDungCt.Update(model);
            _db.SaveChanges();
        ...
        [Route("KkGiaDaXayDungCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaDaXayDungCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaDaXayDungCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaDaXayDungCt.Where(t => t.Mahs == Mahs).ToList();
