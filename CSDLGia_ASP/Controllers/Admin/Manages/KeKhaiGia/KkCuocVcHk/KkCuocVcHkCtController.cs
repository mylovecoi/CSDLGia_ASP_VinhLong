...
{
    public class KkCuocVcHkCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkCuocVcHkCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkCuocVcHkCt/Store")]
        [HttpPost]
        ...
        [Route("KkCuocVcHkCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkCuocVcHkCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkCuocVcHkCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkCuocVcHkCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkCuocVcHkCt.FirstOrDefault(t => t.Id == Id);
            _db.KkCuocVcHkCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkCuocVcHkCt.Where(t => t.Mahs == Mahs).ToList();
