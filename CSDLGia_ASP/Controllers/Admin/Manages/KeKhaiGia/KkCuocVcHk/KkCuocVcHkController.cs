...
namespace CSDLGia_ASP.Controllers.Admin.Manages.KeKhaiGia.KkCuocVcHk
{
    public class KkCuocVcHkController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkCuocVcHkController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KeKhaiGiaCuocVcHk")]
        [HttpGet]
        public IActionResult Index(string Madv, string Nam, string Trangthai)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakk", "Index") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    if (dsdonvi.Count > 0)
                    {
                        ...
                        if (comct.Count > 0)
                        {
                            ...
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá cước vận chuyển hành khách";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgvchk";
                            ViewData["MenuLv3"] = "menu_giakkvchk";
                            return View("Views/Admin/Manages/KeKhaiGia/KkCuocVcHk/Index.cshtml", model);
                        }
                        else
                        {
                            ViewData["Title"] = "Danh sách hồ sơ kê khai giá cước vận chuyển hành khách";
                            ViewData["Messages"] = "Kê khai giá cước vận chuyển hành khách không thuộc quản lý của doanh nghiệp";
                            ViewData["MenuLv1"] = "menu_kknygia";
                            ViewData["MenuLv2"] = "menu_kkgvchk";
                            ViewData["MenuLv3"] = "menu_giakkvchk";
                    ...
                    {
                        ViewData["Title"] = "Danh sách hồ sơ kê khai giá cước vận chuyển hành khách";
                        ViewData["Messages"] = "Hệ thống chưa có doanh nghiệp kê khai giá cước vận chuyển hành khách.";
                        ViewData["MenuLv1"] = "menu_kknygia";
                        ViewData["MenuLv2"] = "menu_kkgvchk";
                        ViewData["MenuLv3"] = "menu_giakkvchk";
                        return View("Views/Admin/Error/ThongBaoLoi.cshtml");
        ...
        [Route("KeKhaiGiaCuocVcHk/Create")]
        [HttpGet]
        public IActionResult Create(string Madv, string Manghe)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakk", "Create") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Tendn"] = _db.Company.FirstOrDefault(t => t.Madv == Madv).Tendn;
                    ViewData["Manghe"] = Manghe;
                    ViewData["Title"] = "Thêm mới Kê khai giá cước vận chuyển hành khách";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvchk";
                    ViewData["MenuLv3"] = "menu_giakkvchk";

                    return View("Views/Admin/Manages/KeKhaiGia/KkCuocVcHk/Create.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Store(VMKkGia request)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var modelct = _db.KkCuocVcHkCt.Where(t => t.Mahs == request.Mahs);
                    if (modelct != null)
                    {
                    ...
                    _db.KkCuocVcHkCt.UpdateRange(modelct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkCuocVcHk", new { request.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaCuocVcHk/Edit")]
        [HttpGet]
        public IActionResult Edit(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakk", "Edit") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkCuocVcHkCt.Where(t => t.Mahs == model_new.Mahs && t.Madv == model_new.Madv);

                    model_new.KkCuocVcHkCt = model_ct.ToList();

                    ViewData["Madv"] = model.Madv;
                    ViewData["Title"] = "Chỉnh sửa Kê khai giá cước vận chuyển hành khách";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvchk";
                    ViewData["MenuLv3"] = "menu_giakkvchk";

                    return View("Views/Admin/Manages/KeKhaiGia/KkCuocVcHk/Edit.cshtml", model_new);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        [Route("KeKhaiGiaCuocVcHk/Update")]
        [HttpPost]
        ...
        [Route("KeKhaiGiaCuocVcHk/Delete")]
        [HttpPost]
        public IActionResult Delete(int id_delete)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakk", "Delete") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    var model_ct = _db.KkCuocVcHkCt.Where(t => t.Mahs == model.Mahs && t.Madv == model.Madv);
                    _db.KkCuocVcHkCt.RemoveRange(model_ct);
                    _db.SaveChanges();

                    return RedirectToAction("Index", "KkCuocVcHk", new { model.Madv });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult Show(string Mahs)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                    ...
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    ViewData["Title"] = "Kê khai giá cước vận chuyển hành khách";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvchk";
                    ViewData["MenuLv3"] = "menu_giakkvchk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkCuocVcHk/Show.cshtml", model);
        ...
        [Route("KeKhaiGiaCuocVcHk/Search")]
        [HttpGet]
        public IActionResult Search(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakk", "Index"))
                {
                    ...
                    var model_join = from kkct in _db.KkCuocVcHkCt
                                     join kk in _db.KkGia.Where(t => t.Manghe == "VCHK" && t.Trangthai == "DD") on kkct.Mahs equals kk.Mahs
                    ...
                    ViewData["Nam"] = Nam;
                    ViewData["Mota"] = Mota;
                    ViewData["Title"] = "Tìm kiếm thông tin kê khai giá cước vận chuyển hành khách";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvchk";
                    ViewData["MenuLv3"] = "menu_giakkvchktk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkCuocVcHk/TimKiem/Index.cshtml", model_join);
        ...
        [Route("KeKhaiGiaCuocVcHk/Printf")]
        [HttpGet]
        public IActionResult Printf(string Nam, string Mota)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakk", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgvchk";
                    ViewData["MenuLv3"] = "menu_giakkvchktk";
                    return View("Views/Admin/Manages/KeKhaiGia/KkCuocVcHk/TimKiem/Printf.cshtml", model_join);
        ...
        public IActionResult Chuyen(string mahs_chuyen, string Ttnguoinop, string Dtll, string Macqcq)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkcvchk.giakkxd", "Approve") ||
                    Helpers.GetSsAdmin(HttpContext.Session, "Level") == "DN")
                {
                    ...
                    _db.KkGia.Update(model);
                    _db.SaveChanges();
                    return RedirectToAction("Index", "KkCuocVcHk", new { model.Madv, Nam = model.Ngaynhap.Year });
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        {
            var modelct = _db.KkCuocVcHkCt.Where(t => t.Mahs == Mahs);
            if (modelct != null)
            {
                hoso.KkCuocVcHkCt = modelct.ToList();
            }
            return hoso;
        }
