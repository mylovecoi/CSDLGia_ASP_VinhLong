...
{
    public class KkGiaThanBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaThanBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("BaoCaoKkGiaThan")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                ...
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá than";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgthan";
                    ViewData["MenuLv3"] = "menu_giakkthanbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaThan/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgthan.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgthan";
                    ViewData["MenuLv3"] = "menu_giakkthanbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaThan/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgthan.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaThanCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá than";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgthan";
                    ViewData["MenuLv3"] = "menu_giakkthanbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaThan/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
