...
{
    public class KkGiaThanCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaThanCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }
        ...
        {
            var model = _db.KkGiaThanCt.FirstOrDefault(p => p.Id == Id);
