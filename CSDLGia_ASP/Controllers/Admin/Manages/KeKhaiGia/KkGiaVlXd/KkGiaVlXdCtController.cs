...
{
    public class KkGiaVlXdCtController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaVlXdCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaVlXdCt/Store")]
        [HttpPost]
        ...
        [Route("KkGiaVlXdCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaVlXdCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaVlXdCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaVlXdCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaVlXdCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaVlXdCt.Remove(model);
            _db.SaveChanges();
            string result = GetData(model.Mahs);
            var data = new { status = "success", message = result };
            return Json(data);
        ...
        {
            var model = _db.KkGiaVlXdCt.Where(t => t.Mahs == Mahs).ToList();
