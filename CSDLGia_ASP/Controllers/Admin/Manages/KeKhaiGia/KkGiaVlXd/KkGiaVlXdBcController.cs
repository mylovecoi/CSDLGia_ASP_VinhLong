...
{
    public class KkGiaVlXdBcController : Controller
    {
        private readonly CSDLGiaDBContext _db;

        public KkGiaVlXdBcController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("BaoCaoKkGiaVlXd")]
        [HttpGet]
        public IActionResult Index()
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgthan.giakkbc", "Index"))
                {
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá vật liệu xây dựng";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvlxd";
                    ViewData["MenuLv3"] = "menu_giakkvlxdbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVlXd/BaoCao/Index.cshtml");
                }
                else
                {
        ...
        public IActionResult BcTongHop(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgthan.giakkbc", "Index"))
                {
                    ...
                    ViewData["MenuLv2"] = "menu_kkgvlxd";
                    ViewData["MenuLv3"] = "menu_giakkvlxdbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVlXd/BaoCao/Bc1.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
        ...
        public IActionResult BcChiTiet(string phanloai, string time, DateTime tungay, DateTime denngay, string thang, string quy, string nam)
        {
            if (!string.IsNullOrEmpty(HttpContext.Session.GetString("SsAdmin")))
            {
                if (Helpers.CheckPermission(HttpContext.Session, "csdlmucgiahhdv.kknygia.kkgthan.giakkbc", "Index"))
                {
                    ...
                    ViewData["quy"] = quy;
                    ViewData["nam"] = nam;
                    ViewData["ct"] = _db.KkGiaVlXdCt.ToList();
                    ViewData["Title"] = "Báo cáo tổng hợp kê khai giá vật liệu xây dựng";
                    ViewData["MenuLv1"] = "menu_kknygia";
                    ViewData["MenuLv2"] = "menu_kkgvlxd";
                    ViewData["MenuLv3"] = "menu_giakkvlxdbc";
                    return View("Views/Admin/Manages/KeKhaiGia/KkGiaVlXd/BaoCao/Bc2.cshtml", model);
                }
                else
                {
                    ViewData["Messages"] = "Bạn không có quyền truy cập vào chức năng này!";
