...
{
    public class KkGiaGiayCtController : Controller
    {
        private readonly CSDLGiaDBContext _db; // khai báo thuộc tính

        public KkGiaGiayCtController(CSDLGiaDBContext db)
        {
            _db = db;
        }

        [Route("KkGiaGiayCt/Store")]
        [HttpPost]
        public JsonResult Store(string Madv, string Tendvcu, string Qccl, string Dvt, double Gialk, double Giakk, string Ghichu)
        {
            var model = new KkGiaGiayCt
            {
        ...
        [Route("KkGiaGiayCt/Edit")]
        [HttpPost]
        public JsonResult Edit(int Id)
        {
            var model = _db.KkGiaGiayCt.FirstOrDefault(p => p.Id == Id);
        ...
        {
            var model = _db.KkGiaGiayCt.FirstOrDefault(t => t.Id == Id);
        ...
        [Route("KkGiaGiayCt/Delete")]
        [HttpPost]
        public JsonResult Delete(int Id)
        {
            var model = _db.KkGiaGiayCt.FirstOrDefault(t => t.Id == Id);
            _db.KkGiaGiayCt.Remove(model);
            _db.SaveChanges();
        ...
        {
            var model = _db.KkGiaGiayCt.Where(t => t.Madv == Madv).ToList();
